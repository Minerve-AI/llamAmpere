                ...
                if (llm_arch_is_recurrent(arch)) {
                    ...
                    if (hparams.swa_type != LLAMA_SWA_TYPE_NONE) {
                        ...
                        res = new llama_memory_hybrid_iswa(
                            ...
                            /* attn_n_pad        */ 1,
                            /* recurrent_type_r  */ (ggml_type) cparams.gdn_state_dtype,
                            /* recurrent_type_s  */ (ggml_type) cparams.gdn_state_dtype,
                        ...
                        res = new llama_memory_hybrid_idx(
                            ...
                            /* recurrent_type_k  */ (ggml_type) cparams.gdn_state_dtype,
                            /* recurrent_type_v  */ (ggml_type) cparams.gdn_state_dtype,
